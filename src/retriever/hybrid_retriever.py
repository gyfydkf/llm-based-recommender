...
def load_faiss_index() -> FAISS:
    """
    Load the FAISS index with lightweight models.

    Returns:
        FAISS retriever object.
    """
    try:
        logger.info("Loading FAISS index with lightweight models...")
        
        # Use lightweight embeddings model if enabled
        if settings.USE_LIGHTWEIGHT_MODELS:
            from src.recommender.lightweight_models import get_lightweight_embeddings
